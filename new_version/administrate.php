            ...
            <main class="container-fluid p-3">
                <div class="border rounded p-3">
                    ...
                    if (isset($_POST['submitCreateGrade'])) {
                        ...
                        $createGrade = htmlspecialchars($_POST['createGrade']);
                        $uses = 0;
                ...
                <div class="border rounded p-3 mt-3">
                    ...
                    if (isset($_POST['submitDeleteGrade'])) {
                        $deleteGrade = htmlspecialchars($_POST['deleteGrade']);
                        $teacherID = $_SESSION['teacherid'];
                ...
                if ($_SESSION['userid'] == "admin") {
                    ...
                    echo '<form style="grid" accept-charset="utf-8" action="administrate.php" method="POST">
                        <div class="row p-3 mb-3">
                            <input class="input-group-text btn btn-outline-danger rounded-pill" type="submit" name="deleteOld" value="Lösche alle Datensätze, die älter als 5 Jahre sind!">
                        </div>
                    </form>';
                    echo "</div>";
                }
                ...
                <div class="row p-3 mb-3">
                    <a class="input-group-text btn btn-outline-primary rounded-pill" href="faqs.php">Fragen zur Benutzung? Hier geht's zu den häufig gestellten Fragen (FAQs)!</a>
                </div>
            </main>
            <script>
