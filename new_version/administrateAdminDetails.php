...
<head>
    ...
    LEFT(workingHoursEnd, 5), responsibility, careRating, companyExperienceRating, jobExperienceRating, personalRating, teacherRating, teacherComment, created, studentName, studentLastName FROM Job WHERE jobID = "' . $jobID . '"';
    ...
    if (isset($_POST['Bearbeiten'])) {
        ...
        $teacherRating = htmlspecialchars($_POST['teacherRating']);
        $teacherComment = htmlspecialchars($_POST['teacherComment']);
    ...
    <div id="page-container">
        <div id="content-wrap">
            ...
            <main class="container-fluid mt-3">
                <form class="grid needs-validation" id="form1" name="form1" accept-charset="utf-8" action="administrateAdminDetails.php<?php echo "?jobID=" . $jobID . "&pinID=" . $pinID . "" ?>" method="POST" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select class="form-select rounded form-control" name="care" <?php echo $disabled ?> required>
                                    ...
                                    <option value="1" <?php echo $disabledSelect ?><?php echo ($care  == "1" ? "selected" : ""); ?>>1</option>
                                    <option value="2" <?php echo $disabledSelect ?><?php echo ($care  == "2" ? "selected" : ""); ?>>2</option>
                ...
                <div class="col">
                    <form class="grid" id="form2" name="form2" accept-charset="utf-8" action="administrateAdminDetails.php<?php echo "?jobID=" . $jobID . "&pinID=" . $pinID . "" ?>" method="POST" novalidate>
        ...
        <div class="grid">
            <div class="row text-center fs-6">
                <div class="col">
                    ...
                    <hr>
                    <p>Schreiben Sie uns gerne eine E-Mail unter: <br>
