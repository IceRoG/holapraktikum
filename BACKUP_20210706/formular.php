...
<body>
    ...
    <form action="formular.php" method="POST">
        ...
        <fieldset>
            ...
            <input type="text" id="berBezeichung" name="berBezeichnung" required>
        </fieldset>
        <fieldset>
            ...
            <input type="text" id="straßeNr" name="straßeNr" required><br>
            ...
            <input type="text" id="homepage" name="homepage" placeholder="-keine-"><br>

            <label for="email">E-Mail-Adresse:</label>
            <input type="email" id="email" name="email" placeholder="-keine-"><br>

            <label for="tel">Telefonnummer:</label>
            <input type="text" id="tel" name="tel" placeholder="-keine-"><br>
            ...
            <textarea rows="4" cols="50" id="voraussetzungen" name="voraussetzungen" placeholder="-keine-"></textarea><br>
        ...
        <fieldset>
            ...
            <textarea rows="4" cols="50" id="anmerkungen" name="anmerkungen" placeholder="-keine-"></textarea><br>
        </fieldset>
