    ...
    <div id="page-container">
        <div id="content-wrap">
            ...
            <main class="container-fluid mt-3">
                <form class="grid needs-validation" id="form1" name="form1" accept-charset="utf-8" action="form.php" method="POST" onSubmit="return confirm('Möchstest du die Daten wirklich absenden?')" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select class="form-select rounded form-control" name="care" required>
                                    ...
                                    <option value="2" <?php echo ($care  == "2" ? "selected" : ""); ?>>1</option>
                                    <option value="3" <?php echo ($care  == "3" ? "selected" : ""); ?>>2</option>
